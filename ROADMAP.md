...
- [x] `volumes/v06-pppoe/03-radius-user-manager-gestao.qmd` — RADIUS e User Manager; integração com sistemas de gestão de provedor (atributos, CoA/desconexão).
- [x] `volumes/v06-pppoe/04-boas-praticas-concentrador.qmd` — Boas práticas de concentrador (BNG): dimensionamento, keepalive, segurança, múltiplos concentradores.
